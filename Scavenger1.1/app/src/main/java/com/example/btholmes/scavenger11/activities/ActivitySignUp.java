...
public class ActivitySignUp extends BasicActivity {
    ...
    /**
     * Updates user display name in Firebase, then adds User to realm, and goes to Main screen
     */
    @Override
                ...
                if(user!=null){
                    Realm.getDefaultInstance().executeTransactionAsync(new Realm.Transaction() {
                        ...
                        public void execute(Realm realm) {
                            User thisUser = new User(user.getUid(), user.getEmail());
                            RealmUser obj = realm.createObject(RealmUser.class, thisUser.getUid());
                            obj.setDisplayName(thisUser.getEmail());
                            obj.setEmail(thisUser.getEmail());
                            obj.setUid(thisUser.getUid());
                            obj.setPhotoUrl(thisUser.getPhotoUrl());
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(password.equals(password2)){
                     ...
                     */
                    createUserWithEmailAndPassword(email, password, new OnCompleteListener<AuthResult>() {
                        @Override
...
//                                updateUserDisplayName(FirebaseAuth.getInstance().getCurrentUser(), email);
                                addUserToDB(user);
                                addPhotoUrl(FirebaseAuth.getInstance().getCurrentUser());
//                                goMainScreen();
                            }
                        }
                    });
