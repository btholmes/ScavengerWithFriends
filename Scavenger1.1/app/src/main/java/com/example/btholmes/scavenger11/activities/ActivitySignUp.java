...
import static com.example.btholmes.scavenger11.R.id.password2;
...
public class ActivitySignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setUpEmailTextListener();
        setPasswordTextListener();
        setSignUpOnClick();
        setSignInOnClick();


        //THIS LISTENER GETS CALLED AFTER THE NEW Profile IS CREATED
                ...
                if(user!=null){
                    ...
                    Realm.getDefaultInstance().executeTransactionAsync(new Realm.Transaction() {
                        ...
                        public void execute(Realm realm) {
                            RealmUser rUser = RealmUser.create(user.getUid(), user.getEmail());
     ...
     * @param user
     */
    private void updateUserDisplayName(FirebaseUser user){
        UserProfileChangeRequest profileUpdates = new UserProfileChangeRequest.Builder()
                .setDisplayName(inputEmail.getText().toString().trim())
                .build();
    ...
    private void initComponents(){
        ...
        inputPassword2 = (EditText) findViewById(password2);
        progressBar = (ProgressBar) findViewById(R.id.progressBar);
    }

    /**
     * Reattach the auth listener
     */
    @Override
                            ...
                            .addOnCompleteListener(ActivitySignUp.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if (!task.isSuccessful()) {
                                        Toast.makeText(ActivitySignUp.this, "Email already in Use",
...
//                                        goMainScreen();
    ...
    private void setPasswordTextListener(){
        ...
        inputPassword2.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if(!password.equals(s.toString()) || s.length() < 6){
                    inputPassword2.setError("Passwords Aren't Correct");
                }else{
    ...
    private void setUpEmailTextListener(){
        inputEmail.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if(matcher.find()){
                    ...
                    inputEmail.setError("Email address not valid");
                }
    ...
    /**
     * Go to main page, and clear back stack so its like user starts anew at first page
     */
    ...
    /**
     * Disables button when form fields aren't filled out correctly
     */
    private void handleSignUpButton(){
        if(emailIsValid && passwordsAreValid){
            btnSignUp.setEnabled(true);
            btnSignUp.setBackground(new ColorDrawable(ContextCompat.getColor(this, R.color.colorAccent)));
